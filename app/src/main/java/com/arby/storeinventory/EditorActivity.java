...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentItemUri == null) {
            ...
            // (Doesn't make sense to delete an item that hasn't been created yet)
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent resultData) {
        if (requestCode == 0 && resultCode == Activity.RESULT_OK) {
            ...
            // Instead, a URI to that document will be contained in the returned intent
            if (resultData != null) {
    ...
    private boolean saveItem() {
        ...
        if (mCurrentItemUri == null &&
            ...
            // Since no fields were modified, return early without creating a new item
    ...
    /**
     * Method is called after invalidateOptionsMenu(), so that the
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                // If the item hasn't changed, navigate up to parent activity
                if (!mItemHasChanged) {
